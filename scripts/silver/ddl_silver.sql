...
-- TO CHECK WHETHER THE TABLE EXIST BEFORE CREATING OR TO CHANGE ANY DATATYPE OR RENAME ANY SPECIFIC FIELD WE ENCOUNTER ERROR,
-- IN ORDER TO AVOID THE ERROR WE HAVE TO BUILD T SQL LOGIC
